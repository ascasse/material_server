...
from model import Bit, group_decoder, category_decoder
from generator import load_model
...
class ModelTest(unittest.TestCase):
    ...
    def test_group_decoder_date_invalid(self):
    ...
    def test_category_decoder_array(self):
        categorylist = load_model(Path('./test/data/current.json'), category_decoder)
    ...
    def test_group_decoder_array(self):
        grouplist = load_model(Path('./test/data/groups.json'), category_decoder)
